...
ORGANIZATION_PUBLIC_EMAIL = config('ORGANIZATION_PUBLIC_EMAIL', default='')
ORGANIZATION_CALL_REDIRECT_NUMBER = config('ORGANIZATION_CALL_REDIRECT_NUMBER', default='')
ORGANIZATION_BANK_CODE = config('ORGANIZATION_BANK_CODE', default='')
ORGANIZATION_BANK_BRANCH_CODE = config('ORGANIZATION_BANK_BRANCH_CODE', default='')
ORGANIZATION_BANK_SWIFT_CODE = config('ORGANIZATION_BANK_SWIFT_CODE', default='')
ORGANIZATION_BANK_ACCOUNT_NAME = config('ORGANIZATION_BANK_ACCOUNT_NAME', default='')
ORGANIZATION_BANK_ACCOUNT_NUMBER = config('ORGANIZATION_BANK_ACCOUNT_NUMBER', default='')
...
CSP_CONNECT_SRC = ("'self'", "https://api.stripe.com", "https://r.stripe.com")
CSP_FRAME_SRC = ("'self'", "https://www.google.com", "https://*.google.com", "https://js.stripe.com")
CSP_IMG_SRC = ("'self'", "data:", "https://*.google.com", "https://*.gstatic.com")